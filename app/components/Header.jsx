  ...
  return (
    <header className="flex justify-between p-6 items-center">
      ...
      <div className="hidden md:flex items-center gap-4">
        <a target="_blank" className="flex items-center gap-2" href="https://www.linkedin.com/in/utkarsh-singh-5630b42aa/">
          LinkedIn
          <GoArrowUpRight />
        </a>
        <a target="_blank" className="flex items-center gap-2" href="https://drive.google.com/file/d/1q25HSTjPWP8skAQ9JE5f9RTdrcS7B3ND/view?usp=sharing">
          Resume
          <GoArrowUpRight />
        </a>
      </div>
